...
class UIHelper {
  ...
  static const Widget horizontalSpaceExtraRegular = SizedBox(width: 24.5);
  ...
  static const Widget horizontalSpaceExtraLarge = SizedBox(width: 110.0);
  static const Widget horizontalSpaceMassive = SizedBox(width: 125.0);
